...
QT_MOC_LITERAL(1, 15, 13), // "returnPressed"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "CustomTextEdit\0returnPressed\0"
};
...
void CustomTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomTextEdit::returnPressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CustomTextEdit::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_CustomTextEdit.data,
      qt_meta_data_CustomTextEdit,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void CustomTextEdit::returnPressed()
{
